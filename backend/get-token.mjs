 ...
 *   2. Run: node get-token.mjs <client_id> <client_secret>
...
if (!clientId || !clientSecret) {
  console.log('Usage: node get-token.mjs <client_id> <client_secret>');
...
console.log('3. You will be redirected to localhost (page will fail to load - that is OK).');
